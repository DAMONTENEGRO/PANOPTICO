...
public class Principal {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        String ruta = "Base de datos csv.csv";
        ...
        System.out.println("\nEJECUTANDO PANOPTICO");
        
        
        // Para leer ruta archivo en consola
        Scanner leer = new Scanner(System.in);
        System.out.print("Para iniciar por favor introduzca la ruta del archivo excel: ");
        ruta = leer.nextLine();
        // Para leer ruta archivo en consola
        
       
        System.out.println("Accediendo a la base de datos... ");
        Equipo chat = new Equipo(ruta, tiempo_minimo_caso_admitido, representatividad_representante, percentil_tiempo_futuro_estado, percentil_procesos, percentil_inferior_promedios, percentil_superior_promedios);
        ...
        while(!salir){
            ...
            if(busqueda.equals("salir")){
                ...
                if(busqueda.equals("realizar pruebas")){
                    ...
                    while((numero_filtros < 1) || (numero_filtros > 8)){
                        System.out.print("Ingrese por favor el numero de filtros que desea utilizar para esta prueba: ");
                        numero_filtros = lectura.nextInt();
                    }
                    ...
                    int datos_a_evaluar = lectura.nextInt();
                    while((datos_a_evaluar > (chat.getCasos().size()*9)*10) || (datos_a_evaluar < 10)) { // Realiza pruebas con hasta 10 veces la cantidad de datos original
                        System.out.println("\n¡No existen suficientes datos para hacer la simulacion! Por favor ingresa un valor diferente de datos.");
                        System.out.print("Ingrese la cantidad de datos que desea evaluar: ");
                        datos_a_evaluar = lectura.nextInt();
                    }
                    busqueda_filtrada(datos_a_evaluar, filtros, chat.getCasos());
                    lectura.nextLine();
                }
            }
        }
