...
public class Combinatoria {
    ...
    // Elimina los datos de las matrices
    
    public void eliminar_datos_combinatoria(){
        matriz_combinaciones_sin_repeticion = new String[0][0];
        matriz_suma_indices = new int[0][0];
    }
